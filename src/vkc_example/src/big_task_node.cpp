...
void InitEnvState(VKCEnvBasic &env)
{
    ...
    env.getVKCEnv()->getTesseract()->addAllowedCollision("Cabinet_417_link", "Cabinet_417_link_dof_rootd_Bb001_r", "Never");
    env.getVKCEnv()->getTesseract()->addAllowedCollision("right_arm_upper_arm_link", "right_arm_base_link_inertia", "Never");
    // env.getVKCEnv()->getTesseract()->addAllowedCollision("hook_1_link", "hook_1_head_link", "Adjacent");
}
getTesseract()
    ...
    int main(int argc, char **argv)
{
    ...
    env.getVKCEnv()->getTesseract()->setState(env.getHomePose());
