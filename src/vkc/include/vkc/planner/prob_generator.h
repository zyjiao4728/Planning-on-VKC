...
namespace vkc
{
  ...
  public:
    ...
    tesseract_planning::ProfileDictionary::Ptr genCartProfiles_(VKCEnvBasic &env, double collision_margin, double collision_coeff, Eigen::Vector3d pos_coeff, Eigen::Vector3d rot_coeff);
  ...
  protected:
    ...
    void setCompositeProfile(tesseract_planning::TrajOptDefaultCompositeProfile::Ptr profile, double margin, double coeff, Eigen::Index num_joints);
    ...
    void setSolverProfile(tesseract_planning::ProfileDictionary::Ptr profiles, int n_iter);
