...
public:
  ...
  BaseFridge(std::string object_name, double h = 1, double w = 0.6, double d = 0.8)
  ...
  bool createObject() override
  {
    ...
    fridge_bottom_link_visual->geometry = std::make_shared<tesseract_geometry::Box>(w_, d_, bottom_thickness);
    material_name = fridge_bottom_link.getName() + "_color";
    fridge_bottom_link_visual->material = std::make_shared<Material>(material_name);
    ...
    fridge_bottom_link_collision->geometry = fridge_bottom_link_visual->geometry;
    ...
    fridge_door_link_visual->origin.translation() = Eigen::Vector3d(0, d_ / 2.0, 0);
    ...
    fridge_door_link_visual->material = std::make_shared<Material>(material_name);
    ...
    fridge_back_link_visual->origin.translation() = Eigen::Vector3d(0, -d_ / 2.0, 0);
    fridge_back_link_visual->geometry =
        std::make_shared<tesseract_geometry::Box>(wall_thickness, d_, h_ - bottom_thickness);
    material_name = fridge_back_link.getName() + "_color";
    fridge_back_link_visual->material = std::make_shared<Material>(material_name);
    ...
    fridge_left_link_visual->material = std::make_shared<Material>(material_name);
    ...
    fridge_right_link_visual->material = std::make_shared<Material>(material_name);
    ...
    fridge_bottom_joint.parent_to_joint_origin_transform = Eigen::Isometry3d::Identity();
    fridge_bottom_joint.parent_to_joint_origin_transform.translation() += Eigen::Vector3d(0, 0, bottom_thickness / 2);
    ...
    fridge_level1_joint.parent_to_joint_origin_transform = Eigen::Isometry3d::Identity();
    ...
    fridge_top_joint.parent_to_joint_origin_transform = Eigen::Isometry3d::Identity();
    ...
    fridge_door_joint.parent_to_joint_origin_transform = Eigen::Isometry3d::Identity();
    fridge_door_joint.parent_to_joint_origin_transform.translation() += Eigen::Vector3d(-w_ / 2.0, -d_ / 2.0, h_ / 2.0);
    ...
    fridge_back_joint.parent_to_joint_origin_transform = Eigen::Isometry3d::Identity();
    ...
    fridge_left_joint.parent_to_joint_origin_transform = Eigen::Isometry3d::Identity();
    ...
    fridge_right_joint.parent_to_joint_origin_transform = Eigen::Isometry3d::Identity();
    ...
    knob1_joint.parent_to_joint_origin_transform.translation() += Eigen::Vector3d(-0.015, d_ - 0.1, h_/2 - 0.1);
    ...
    knob2_joint.parent_to_joint_origin_transform.translation() += Eigen::Vector3d(-0.015, d_ - 0.1, h_/2 - 0.23);
    ...
    link_map_[fridge_bottom_link.getName()] = std::make_shared<Link>(std::move(fridge_bottom_link));
    ...
    link_map_[fridge_back_link.getName()] = std::make_shared<Link>(std::move(fridge_back_link));
    link_map_[fridge_left_link.getName()] = std::make_shared<Link>(std::move(fridge_left_link));
    link_map_[fridge_right_link.getName()] = std::make_shared<Link>(std::move(fridge_right_link));
    link_map_[fridge_door_link.getName()] = std::make_shared<Link>(std::move(fridge_door_link));
    ...
    joint_map_[fridge_bottom_joint.getName()] = std::make_shared<Joint>(std::move(fridge_bottom_joint));
    joint_map_[fridge_door_joint.getName()] = std::make_shared<Joint>(std::move(fridge_door_joint));
    joint_map_[fridge_level1_joint.getName()] = std::make_shared<Joint>(std::move(fridge_level1_joint));
    joint_map_[fridge_top_joint.getName()] = std::make_shared<Joint>(std::move(fridge_top_joint));
    joint_map_[fridge_back_joint.getName()] = std::make_shared<Joint>(std::move(fridge_back_joint));
    joint_map_[fridge_left_joint.getName()] = std::make_shared<Joint>(std::move(fridge_left_joint));
    joint_map_[fridge_right_joint.getName()] = std::make_shared<Joint>(std::move(fridge_right_joint));
    ...
    attach_location.local_joint_origin_transform.translation() += Eigen::Vector3d(-0.1, 0, 0.0);
