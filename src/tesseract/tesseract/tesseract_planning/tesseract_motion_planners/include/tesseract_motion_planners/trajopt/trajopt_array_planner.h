...
struct TrajOptArrayPlannerConfig
{
  ...
  TrajOptArrayPlannerConfig() {configuration_ = std::make_shared<JointWaypoint>(Eigen::VectorXd(), std::vector<std::string>());}
  ...
  JointWaypoint::ConstPtr configuration_; // to adapt the new class definition @2021-11-01, wanglei@bigai.ai
